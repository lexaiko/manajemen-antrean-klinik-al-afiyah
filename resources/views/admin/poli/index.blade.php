            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/admin/poli"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">poli</a>
                    </div>
                </li>
            </ol>
        </nav>
                ...
                <div class="flex items-center w-full">
                    <form action="" method="GET" class="flex items-center w-full max-w-md space-x-2">
                        <div class="relative flex-grow">
                            ...
                            <input type="text" name="search" placeholder="Cari poli..."
                    ...
                    <tbody>
                        @foreach ($polis as $poli)
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">
                                    {{ ($polis->currentPage() - 1) * $polis->perPage() + $loop->iteration }}</td>
                                <td class="px-4 py-3">{{ $poli->nama_poli }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="actionsDropdownButton-{{ $poli->id }}"
                                        data-dropdown-toggle="actionsDropdown-{{ $poli->id }}"
                                    ...
                                    <!-- Dropdown menu -->
                                    <div id="actionsDropdown-{{ $poli->id }}"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="actionsDropdownButton-{{ $poli->id }}">
                                            <li>
