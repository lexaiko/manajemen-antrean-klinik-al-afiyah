            ...
            <div class="grid gap-2 sm:grid-cols-2 sm:gap-2">
                <div class="sm:col-span-2">
                    ...
                    <div>
                        ...
                        <input type="nik" name="nik_pasien" id="nik"
                    ...
                    <div>
                        <label for="alamat_pasien"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat Pasien</label>
                        <input type="alamat_pasien" name="alamat_pasien" id="alamat_pasien"
                    ...
                    <div>
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="keluhan" id="keluhan"
                                ...
                                value="{{ old('keluhan', $antrians->keluhan) }}" required>
                            @error('keluhan')
                                <div class="invalid-feedback text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        <div>
                            ...
                            <select id="status" name="status"
                                ...
                                <option value="ditangguhkan" {{ old('status') == '2' ? 'selected' : '' }}>Ditangguhkan
                                </option>
                                <option value="dilayani" {{ old('status') == '3' ? 'selected' : '' }}>Sedang Dilayani
                                </option>
