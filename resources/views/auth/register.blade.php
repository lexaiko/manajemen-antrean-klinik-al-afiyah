    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"
                            required autocomplete="new-password" placeholder="Masukkan Kata Sandi Anda" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full"
                            type="password"
                            name="password_confirmation" required autocomplete="new-password" placeholder="Konfirmasi Kata Sandi Anda" />
        ...
        <div class="mt-4">
            ...
            <select id="jenis_kelamin" name="jenis_kelamin" class="block mt-1 w-full rounded-lg border-gray-300" required>
