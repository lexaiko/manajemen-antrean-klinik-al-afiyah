    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            ...
            <button type="button"
                ...
                <!-- Icon SVG Produk -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="{{ request()->is('admin/user*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') ? 'white' : 'black' }}"
                ...
                <!-- Icon Dropdown -->
                <svg class="w-3 h-3 {{ request()->is('admin/user*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') ? 'text-white' : 'text-gray-800' }}"
            ...
            <ul id="manajemen-antrean"
                ...
                <li>
                    <a href="{{ route('admin.monitoring') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="{{ request()->is('admin/monitoring*') ? 'white' : 'black' }}" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul class="pt-5 mt-5 space-y-2 ">
                <li>
                    <a href="/admin/profile"
                        class="flex items-center p-2 text-base font-medium rounded-lg transition duration-75 group {{ request()->is('admin/profile') ? 'bg-green-600 text-white hover:bg-green-600 hover:text-white' : 'text-gray-900 hover:bg-gray-100' }} dark:text-white dark:hover:bg-gray-700">
                        <svg class="w-[31px] h-[31px] {{ request()->is('admin/profile') ? 'text-white' : 'text-gray-800 dark:text-white' }}" aria-hidden="true"
