<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            ...
            <button type="button"
                class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group {{ request()->is('admin/user*') || request()->is('admin/poli*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') ? 'bg-green-600 text-white' : '' }}"
                aria-controls="dropdown-example"
                aria-expanded="{{ request()->is('admin/user*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') || request()->is('admin/poli*') ? 'true' : 'false' }}"
                data-collapse-toggle="dropdown-example">
                <!-- Icon SVG Produk -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="{{ request()->is('admin/user*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') || request()->is('admin/poli*') ? 'white' : 'black' }}"
                ...
                <!-- Icon Dropdown -->
                <svg class="w-3 h-3 {{ request()->is('admin/user*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') || request()->is('admin/poli*') ? 'text-white' : 'text-gray-800' }}"
            ...
            <ul id="dropdown-example"
                class="{{ request()->is('admin/user*') || request()->is('admin/role*') || request()->is('admin/tenagamedis*') || request()->is('admin/poli*') ? '' : 'hidden' }} py-2 space-y-2">
                <li>
                    <a href="{{ url('admin/user') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="{{ request()->is('admin/user*') ? 'white' : 'black' }}" stroke-width="2"
                ...
                <li>
                    <a href="{{ url('admin/role') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="{{ request()->is('admin/role*') ? 'white' : 'black' }}" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-icon lucide-user">
                            <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
                            <circle cx="12" cy="7" r="4" />
                        </svg>
            ...
            <button type="button"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-logs-icon lucide-logs">
                    <path d="M13 12h8" />
                    <path d="M13 18h8" />
                    <path d="M13 6h8" />
                    <path d="M3 12h1" />
            ...
            <ul id="manajemen-antrean"
                ...
                <li>
                    <a href="{{ route('admin.antrian.riwayat') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-list-end-icon lucide-list-end"><path d="M16 12H3"/><path d="M16 6H3"/><path d="M10 18H3"/><path d="M21 6v10a2 2 0 0 1-2 2h-5"/><path d="m16 16-2 2 2 2"/></svg>
            ...
            <button type="button"
                ...
                <!-- Icon SVG Produk -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="{{ request()->is('admin/jadwal*') ? 'white' : 'black' }}" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul id="manajemen-jadwal"
                ...
                <li>
                    <a href="{{ url('admin/jadwal') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="{{ request()->is('admin/jadwal') ? 'white' : 'black' }}" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <button type="button"
                ...
                <!-- Icon SVG Produk -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="{{ request()->is('admin/konten*') ? 'white' : 'black' }}" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-palette-icon lucide-palette">
                    <path
            ...
            <ul id="manajemen-konten"
                ...
                <li>
                    <a href="{{ url('admin/konten/kategori') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="{{ request()->is('admin/konten/kategori') ? 'white' : 'black' }}"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-chart-column-stacked-icon lucide-chart-column-stacked">
                            <path d="M11 13H7" />
                            <path d="M19 9h-4" />
                ...
                <li>
                    <a href="{{ url('admin/konten') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="{{ request()->is('admin/konten') ? 'white' : 'black' }}" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-chart-column-stacked-icon lucide-chart-column-stacked">
                            <path d="M11 13H7" />
                            <path d="M19 9h-4" />
