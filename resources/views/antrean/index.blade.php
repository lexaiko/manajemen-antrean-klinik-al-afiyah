...
@section('content')
    ...
    <section class="jumbotron w-full min-h-[70vh] md:min-h-screen flex flex-col justify-center">
        <div class="relative w-full h-56 md:h-96 overflow-hidden">
            ...
            <div
                class="absolute inset-0 flex flex-col justify-center items-start bg-black/40 text-white px-6 md:px-24">
...
<div class="flex flex-col md:flex-row md:justify-between md:items-center mb-4 gap-2">
    <form method="GET" action="{{ route('antrean.index') }}" class="flex items-center gap-2 w-full md:w-auto">
